...
public class AccessDirectBuffer {
	...
	public void directAccess(){
		...
		System.out.println("test Direct Write cost : " + (System.currentTimeMillis() - start));
	}
	...
	public void directAllocate(){
		...
		System.out.println("test Direct allocate cost : " + (System.currentTimeMillis() - start));
	}
	...
	public void bufferAccess(){
		...
		System.out.println("test Buffer Write cost : " + (System.currentTimeMillis() - start));
	}
	...
	public void bufferAllocate(){
		...
		System.out.println("test Buffer allocate cost : " + (System.currentTimeMillis() - start));
	}

	public static void testWrite(){
		AccessDirectBuffer alloc = new AccessDirectBuffer();

		/*	client	直接内存在访问读写上有较大优势
			test Buffer Write cost : 503
			test Direct Write cost : 139

			test Buffer Write cost : 664
			test Direct Write cost : 118		直接内存访问速度快于堆内存
		 */
		/*	server
			test Buffer Write cost : 509
			test Direct Write cost : 149

			test Buffer Write cost : 678
			test Direct Write cost : 202
		 */
		alloc.bufferAccess();
		alloc.directAccess();
	...
	public static void testAllocate(){
		...
		/*	直接内存在内存空间申请时没有优势
			test Direct allocate cost : 859
			test Buffer allocate cost : 444
			test Direct allocate cost : 634
			test Buffer allocate cost : 290
		 */
	}
